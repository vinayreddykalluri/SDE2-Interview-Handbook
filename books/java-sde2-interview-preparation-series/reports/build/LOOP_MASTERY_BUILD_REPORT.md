...
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/01-loop-execution-from-zero.md`
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/02-index-ranges-invariants-and-search.md`
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/03-two-pointers-compaction-and-merge.md`
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/04-sliding-windows-and-aggregate-work.md`
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/05-grid-indexes-and-matrix-traversals.md`
- `content/volumes/05-loop-mastery-and-index-calculations/chapters/06-sde2-loop-reasoning-and-java-internals.md`
- `content/volumes/05-loop-mastery-and-index-calculations/exercises/01-loop-mastery-practice-lab.md`
- `content/volumes/05-loop-mastery-and-index-calculations/solutions/01-loop-mastery-practice-solutions.md`
...
```text
05: ./dist/Java-SDE2-DSA-05-Loop-Mastery-and-Index-Calculations.pdf (95 pages)
```
...
- Path: `./dist/Java-SDE2-DSA-05-Loop-Mastery-and-Index-Calculations.pdf`
- Page count: **95**
