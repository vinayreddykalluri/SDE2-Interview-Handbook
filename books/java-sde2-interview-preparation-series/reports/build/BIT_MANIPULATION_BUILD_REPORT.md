...
- `content/volumes/04-bit-manipulation-in-java/chapters/01-bits-and-java-operators-from-zero.md`
- `content/volumes/04-bit-manipulation-in-java/chapters/02-masks-core-techniques-and-shortcuts.md`
- `content/volumes/04-bit-manipulation-in-java/chapters/03-xor-patterns-and-prefix-state.md`
- `content/volumes/04-bit-manipulation-in-java/chapters/04-subsets-submasks-and-compact-state.md`
- `content/volumes/04-bit-manipulation-in-java/chapters/05-sde2-bit-interview-patterns.md`
- `content/volumes/04-bit-manipulation-in-java/chapters/06-java-apis-production-and-revision.md`
- `content/volumes/04-bit-manipulation-in-java/exercises/01-bit-manipulation-practice-lab.md`
- `content/volumes/04-bit-manipulation-in-java/solutions/01-bit-manipulation-practice-solutions.md`
...
```text
04: ./dist/Java-SDE2-DSA-04-Bit-Manipulation-in-Java.pdf (109 pages)
```

## Final PDF

- Path: `./dist/Java-SDE2-DSA-04-Bit-Manipulation-in-Java.pdf`
- Page count: **109**
