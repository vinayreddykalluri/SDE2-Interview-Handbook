...
Use this chapter's execution model for the rest of `JAVA-01`. Continue to `JAVA-06` for class loading, JIT, garbage collection, stack frames, and memory diagnostics. Continue to `JAVA-04` for modules, packaging, and language evolution in depth.
