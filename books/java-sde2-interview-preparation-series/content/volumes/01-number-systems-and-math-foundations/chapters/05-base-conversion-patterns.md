...
![Base conversion map: parsing turns text into a value; formatting turns a value into text.](content/volumes/01-number-systems-and-math-foundations/assets/10-base-conversion-map.png)

### Base text to a value

![Positional accumulation validates each digit before multiplying the current value by the base.](content/volumes/01-number-systems-and-math-foundations/assets/04-base-to-decimal-positional-accumulation.png)
...
![Repeated division records remainders from least significant to most significant.](content/volumes/01-number-systems-and-math-foundations/assets/03-decimal-to-binary-repeated-division.png)
