...
![Factor pairs meet at the square root, so the scan covers every factor without traversing to n.](content/volumes/01-number-systems-and-math-foundations/assets/14-factor-pairs.png)
...
![The Sieve of Eratosthenes marks composite values and retains primes through a chosen limit.](content/volumes/01-number-systems-and-math-foundations/assets/15-sieve-process.png)
...
![Euclid's algorithm preserves the common divisors while replacing a pair with its remainder.](content/volumes/01-number-systems-and-math-foundations/assets/07-euclidean-gcd-process.png)
