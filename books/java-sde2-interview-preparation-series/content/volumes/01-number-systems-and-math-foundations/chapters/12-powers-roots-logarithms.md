...
![Powers of two connect repeated doubling, repeated halving, fixed-width bounds, and logarithms.](content/volumes/01-number-systems-and-math-foundations/assets/09-powers-of-two-scale.png)
...
![Fast exponentiation uses the binary form of the exponent to choose squared factors in logarithmic time.](content/volumes/01-number-systems-and-math-foundations/assets/16-fast-exponentiation.png)
