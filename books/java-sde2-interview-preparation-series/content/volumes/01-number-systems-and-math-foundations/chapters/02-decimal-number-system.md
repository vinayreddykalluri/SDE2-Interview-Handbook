...
![Decimal place value: each digit contributes its value times a power of ten.](content/volumes/01-number-systems-and-math-foundations/assets/01-decimal-place-value.png)

![A dry run of the digit loop shows the last digit and remaining prefix changing at every step.](content/volumes/01-number-systems-and-math-foundations/assets/12-digit-extraction-loop.png)
