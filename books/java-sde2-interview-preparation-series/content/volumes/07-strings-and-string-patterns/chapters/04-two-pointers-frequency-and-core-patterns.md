...
![Opposing pointers and the palindrome invariant](content/volumes/07-strings-and-string-patterns/assets/05-palindrome-two-pointers.png)
...
![Frequency state and the anagram contract](content/volumes/07-strings-and-string-patterns/assets/06-frequency-and-anagram-state.png)
