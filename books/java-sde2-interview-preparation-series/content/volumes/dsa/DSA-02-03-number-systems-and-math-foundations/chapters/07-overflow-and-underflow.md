...
![Signed integer overflow wraps across the fixed-width boundary unless code checks the operation.](content/volumes/dsa/DSA-02-03-number-systems-and-math-foundations/assets/06-integer-overflow-wraparound.png)
