...
![Modulo as a clock: normalized values map every integer to one position in the cycle.](content/volumes/dsa/DSA-02-03-number-systems-and-math-foundations/assets/08-modular-clock.png)
