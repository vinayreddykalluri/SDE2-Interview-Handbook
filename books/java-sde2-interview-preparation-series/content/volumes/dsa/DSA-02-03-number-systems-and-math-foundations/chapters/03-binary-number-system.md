...
![Binary place value: each bit contributes zero or one times a power of two.](content/volumes/dsa/DSA-02-03-number-systems-and-math-foundations/assets/02-binary-place-value.png)
