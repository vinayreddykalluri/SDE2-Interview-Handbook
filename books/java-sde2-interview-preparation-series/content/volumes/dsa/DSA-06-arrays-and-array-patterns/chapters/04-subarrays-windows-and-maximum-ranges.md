...
![A fixed-size sliding window removes one value and adds one value](content/volumes/dsa/DSA-06-arrays-and-array-patterns/assets/06-sliding-window-state.png)
