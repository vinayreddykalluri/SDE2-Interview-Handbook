...
![Sorted two-pointer elimination removes one impossible boundary at a time](content/volumes/dsa/DSA-06-arrays-and-array-patterns/assets/03-opposing-two-pointer-elimination.png)
...
![Read scans the input while write grows the valid output prefix](content/volumes/dsa/DSA-06-arrays-and-array-patterns/assets/04-read-write-compaction.png)
...
![Dutch national flag partitions settled regions around one unknown interval](content/volumes/dsa/DSA-06-arrays-and-array-patterns/assets/05-three-way-partition-regions.png)
