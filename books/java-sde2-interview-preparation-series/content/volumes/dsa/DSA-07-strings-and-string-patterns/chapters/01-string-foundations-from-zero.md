...
![String references and immutable values](content/volumes/dsa/DSA-07-strings-and-string-patterns/assets/01-string-values-references-immutability.png)
...
![Null, empty, and blank contracts](content/volumes/dsa/DSA-07-strings-and-string-patterns/assets/03-null-empty-blank-contract.png)
