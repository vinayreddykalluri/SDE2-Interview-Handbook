...
![Fixed and variable sliding-window state transitions](content/volumes/dsa/DSA-05-loop-mastery-and-index-calculations/assets/05-sliding-window-state.png)
...
![Counting total pointer movement instead of multiplying visible loop bounds](content/volumes/dsa/DSA-05-loop-mastery-and-index-calculations/assets/06-aggregate-pointer-movement.png)
