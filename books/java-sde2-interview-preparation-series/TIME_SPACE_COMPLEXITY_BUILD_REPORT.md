...
1. `series/volumes/02-time-and-space-complexity/chapters/01-complexity-from-zero.md`
2. `series/volumes/02-time-and-space-complexity/chapters/02-reading-complexity-from-java-code.md`
3. `series/volumes/02-time-and-space-complexity/chapters/03-space-complexity-from-zero.md`
4. `series/volumes/02-time-and-space-complexity/chapters/04-java-collections-cost-models.md`
5. `series/volumes/02-time-and-space-complexity/chapters/05-sde2-complexity-reasoning.md`
6. `book/appendices/b-collection-complexity.md`
7. `series/volumes/02-time-and-space-complexity/exercises/01-complexity-practice-lab.md`
8. `series/volumes/02-time-and-space-complexity/solutions/01-complexity-practice-solutions.md`
9. `series/volumes/02-time-and-space-complexity/code/ComplexityExamples.java` (builder-injected companion)

Manifest and shared publisher:

- `series/series.json`
- `scripts/build_series.py`
- `series/assets/modern-series-cover-background-v2.png`
...
Targeted Volume 02 build, run from `/Users/vinayreddykalluri/Documents/Java SDE 2 Interview Book`:
...
- Path: `/Users/vinayreddykalluri/Documents/Java SDE 2 Interview Book/series/dist/Java-SDE2-DSA-02-Time-and-Space-Complexity.pdf`
- Page count: **79**
