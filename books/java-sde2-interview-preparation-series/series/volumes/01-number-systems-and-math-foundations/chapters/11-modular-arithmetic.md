...
![Modulo as a clock: normalized values map every integer to one position in the cycle.](series/volumes/01-number-systems-and-math-foundations/assets/08-modular-clock.png)
