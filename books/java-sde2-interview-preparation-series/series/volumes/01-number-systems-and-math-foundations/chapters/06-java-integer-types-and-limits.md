...
![Java primitive integer ranges and the promotion rules that matter in interviews.](series/volumes/01-number-systems-and-math-foundations/assets/05-java-primitive-ranges.png)
