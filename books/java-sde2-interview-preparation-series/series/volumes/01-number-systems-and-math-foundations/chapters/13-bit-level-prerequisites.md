...
![An 8-bit example visualizes two's-complement negation and the asymmetric signed range.](series/volumes/01-number-systems-and-math-foundations/assets/13-twos-complement-intuition.png)
