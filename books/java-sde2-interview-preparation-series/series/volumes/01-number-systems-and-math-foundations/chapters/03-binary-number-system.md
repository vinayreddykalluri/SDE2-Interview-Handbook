...
![Binary place value: each bit contributes zero or one times a power of two.](series/volumes/01-number-systems-and-math-foundations/assets/02-binary-place-value.png)
