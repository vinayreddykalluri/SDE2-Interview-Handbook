...
![Mapping row and column coordinates to a row-major flat index](series/volumes/05-loop-mastery-and-index-calculations/assets/07-flatten-unflatten-grid.png)
...
![Spiral traversal as processed rings and a shrinking unvisited rectangle](series/volumes/05-loop-mastery-and-index-calculations/assets/08-spiral-boundaries.png)
