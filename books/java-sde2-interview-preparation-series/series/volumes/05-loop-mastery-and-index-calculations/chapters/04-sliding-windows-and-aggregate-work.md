...
![Fixed and variable sliding-window state transitions](series/volumes/05-loop-mastery-and-index-calculations/assets/05-sliding-window-state.png)
...
![Counting total pointer movement instead of multiplying visible loop bounds](series/volumes/05-loop-mastery-and-index-calculations/assets/06-aggregate-pointer-movement.png)
