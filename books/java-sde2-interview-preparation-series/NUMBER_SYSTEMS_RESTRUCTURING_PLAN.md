...
| Volume manifest | Part B advertised only 30 algorithms and omitted new modules | `series/series.json` entries 01B only | Update Part B subtitle/outcomes and add two sources | Complete |
