...
- `series/series.json`, the targeted builder, renderer, manifest, and existing PDFs;
...
- only the 01B entry in `series/series.json` for new sources and 52-implementation cover language;
- `series/dist/manifest.json` entries for 01 and 01B;
...
```bash
/Users/vinayreddykalluri/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 scripts/generate_number_system_diagrams.py --contact-sheet
bash scripts/validate_number_system_examples.sh
/Users/vinayreddykalluri/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 scripts/build_series.py --volume 01 --skip-index
/Users/vinayreddykalluri/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 scripts/build_series.py --volume 01B --skip-index
```
...
|---|---:|---:|---|
| `series/dist/Java-SDE2-DSA-01-Number-Systems-and-Math-Foundations.pdf` | 125 | 6,248,979 | `8a23bb3c8f1cf34b3fedad591750ad5e0550f543fa95e433ede0c2fbe7917815` |
| `series/dist/Java-SDE2-DSA-01B-Number-Systems-Interview-Workbook.pdf` | 137 | 3,973,634 | `143080589afcefd67682c9d64b4c9c91c6688110184bdbe63779baef75ad2906` |
...
- unique local sibling targets checked against `series/dist`: all present
