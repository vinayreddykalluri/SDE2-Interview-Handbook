...
After Java Foundations, continue to `Java-SDE2-DSA-02-Time-and-Space-Complexity.pdf`, then use `Java-SDE2-DSA-01-Number-Systems-and-Math-Foundations.pdf` for a printable numeric quick-reference with worked algorithms. For the full focused sequence, open `series/dist/Java-SDE2-Interview-Preparation-Series-Index.pdf`.
