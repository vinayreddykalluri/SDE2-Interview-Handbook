...
|---|---:|---|
| `series/dist/Java-SDE2-DSA-01-Number-Systems-and-Math-Foundations.pdf` | 125 | `8a23bb3c8f1cf34b3fedad591750ad5e0550f543fa95e433ede0c2fbe7917815` |
| `series/dist/Java-SDE2-DSA-01B-Number-Systems-Interview-Workbook.pdf` | 137 | `143080589afcefd67682c9d64b4c9c91c6688110184bdbe63779baef75ad2906` |
| `series/dist/Java-SDE2-Interview-Preparation-Series-Index.pdf` | 13 | `3c6232f7570623717dd4b3f2be61d8788664fcd5d2c7fe89b83f594864be5883` |
...
- 18 chapter sources under `series/volumes/01-number-systems-and-math-foundations/chapters/`
...
- per-volume assembled Markdown and Pandoc AST files under `series/build/`
- distributable PDFs and the cryptographic artifact manifest under `series/dist/`
- complete Poppler page renders, reports, and review sheets under `series/tmp/pdfs/`
...
From `/Users/vinayreddykalluri/Documents/Java SDE 2 Interview Book`:
...
python3 scripts/qa_series_render.py \
  --output series/tmp/pdfs/final-release-20260725-v1 --dpi 54
```
...
Some PDF viewers block local sibling-file links for security. Every link therefore has a printed filename fallback; keep all release PDFs together in `series/dist/` for the best navigation experience.
