...
Pre-improvement PDF: `series/dist/Java-SDE2-DSA-03-Java-Foundations-for-Problem-Solving.pdf` (89 pages)  
...
The canonical PDF is assembled by `scripts/build_series.py` from the Volume 03 entry in `series/series.json`. Editable Markdown and Java sources are canonical; `series/build/03-java-foundations-for-problem-solving/volume.md` and the PDF in `series/dist` are generated artifacts.
