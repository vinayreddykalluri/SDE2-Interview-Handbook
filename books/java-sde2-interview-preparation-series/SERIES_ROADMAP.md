...
- Keep the PDFs together in `series/dist/` so relative links can work in compatible viewers.
...
- `series/dist/manifest.json` records page counts and SHA-256 hashes for artifact verification.
