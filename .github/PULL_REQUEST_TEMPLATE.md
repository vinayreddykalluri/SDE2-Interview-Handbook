...
Describe the learner, contributor, or build problem and the change that addresses it.
...
Explain the invariant, source, standard, or implementation detail used to establish correctness.
...
Include screenshots for visual changes and identify any PDF or DOCX pages inspected.
