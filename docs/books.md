...
6. Arrays, Strings, Hashing, Recursion, and the remaining DSA modules
7. Advanced Java and backend engineering volumes

Stable volume numbers remain in filenames, while the books' internal learning-step labels show the recommended route.
