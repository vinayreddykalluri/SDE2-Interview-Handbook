...
The consolidated repository includes 40 focused books, a 17-page series index, and a 616-page master book. The focused books contain 2,684 pages; the complete 42-PDF library contains 3,317 pages.

| Publication status | Books | Meaning |
|---|---:|---|
| Full edition | 32 | Developed instructional content with examples, practice, navigation, and technical validation |
| Roadmap edition | 8 | Published scope, prerequisites, chapter plan, interview outcomes, and completion gate; expanded one book at a time |
...
Publication-depth framework books: [Spring Framework](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-04-Spring-Framework.pdf), with 21 web/PDF chapters and executable Spring 7 behavior tests; and [Spring Boot](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-05-Spring-Boot.pdf), with 23 chapters, executable Boot 4.1 validation, realistic interview rounds, and production failure playbooks.

Roadmap PDFs still being expanded: [MySQL](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-02-MySQL.pdf) · [Hibernate and JPA](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-03-Hibernate-and-JPA.pdf) · [Spring Data](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-06-Spring-Data.pdf) · [MongoDB](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-07-MongoDB.pdf) · [Redis](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-08-Redis.pdf) · [Apache Kafka and Spring Kafka](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-09-Apache-Kafka-and-Spring-Kafka.pdf) · [Spring Ecosystem Extensions](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-10-Spring-Ecosystem-Extensions.pdf) · [Spring AI](books/java-sde2-interview-preparation-series/dist/Java-SDE2-SD-11-Spring-AI.pdf)
